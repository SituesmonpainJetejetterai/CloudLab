...
resource "aws_launch_template" "ec2_instance_launch_template_saltstack_master"{
  ...
  iam_instance_profile {
    arn = aws_iam_instance_profile.ec2_instance_profile_saltstack.arn
  }
  ...
  key_name = aws_key_pair.ec2_instance_key_pair_saltstack.key_name
...
resource "aws_iam_role" "ec2_instance_role_saltstack" {
  ...
  assume_role_policy = data.aws_iam_policy_document.ec2_instance_policy_saltstack.json
}

resource "aws_iam_instance_profile" "ec2_instance_profile_saltstack" {
  name = var.ec2_instance_profile_saltstack
  role = aws_iam_role.ec2_instance_role_saltstack.name
}
